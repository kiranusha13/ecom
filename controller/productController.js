...
export const createProductController = async( req, res) => {
    ...
    try {
        const {name,description,price,category,quantity,slug} = req.fields
...
export const getProductController = async(req,res) =>{
    try {
        ...
        res.status(500).send({
            success:false,
            message:'error in getting poduct',
            error:error.message,
        })
    }
}
...
export const deleteProductController = async(req,res) =>{
    try {
         ...
         res.status(200).send({
            success:'true',
            message:'product is succesfuly deleted',
         })
    } catch (error) {
       console.log('error') 
       res.status(500).send({
        success:false,
        message:'Error while daleting product',
        error
       })
    }
}
...
export const productCountController=async (req,res)=>{
    try {
        ...
        console.log(error)
        res.staus(400).send({
            message:'errir in product count',
            error,
            success:false,
